...
//     useEffect(() => {
//         gsap.from("animation", { opacity: 0, y: 100, duration: 1 });
//     }, []);
//     return (
...
const files = [
    {
        name: "dashboard.tsx",
        body: "Building responsive layouts...",
    },
    {
        name: "api-routes.ts",
        body: "Setting up backend logic...",
    },
    {
        name: "database.sql",
        body: "Optimizing queries...",
    },
    {
        name: "mobile-app.dart",
        body: "Creating native experiences...",
    },
    {
        name: "ai-agent.py",
        body: "Training intelligent models...",
    },
]
...
const services = [
                ...
                <div className="absolute inset-0 opacity-30">
                    <div className="grid grid-cols-8 grid-rows-8 h-full w-full">
                        {Array.from({ length: 64 }).map((_, i) => (
                            <div
                                key={i}
                                className="border border-purple-300/20 animate-pulse"
                                style={{
    ...
    },
    {
        ...
        description: "Cutting-edge technologies and frameworks powering modern, scalable applications.",
        href: "#",
        cta: "Explore Stack",
        ...
        background: (
            <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/10 via-purple-500/10 to-pink-500/10">
                <div className="absolute inset-0 flex items-center justify-center">
                    <IconCloud images={techSlugs.map((slug) => `https://cdn.simpleicons.org/${slug}`)} />
                </div>
            </div>
        ),
    },
    {
        ...
        description: "End-to-end development with modern tech stacks. From database design to stunning frontends.",
        href: "#",
    ...
    },
    {
        ...
        description: "Scalable, secure, and performant backend systems built with best practices and modern frameworks.",
        href: "#",
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                    <div className="grid grid-cols-3 gap-4 p-8">
                        {[...Array(9)].map((_, i) => (
                            <div
                                key={i}
                                className="h-12 w-12 rounded-lg bg-blue-500/40 animate-pulse"
                                style={{
        ...
        background: (
            <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative h-[300px] w-[150px]">
                    <div className="absolute inset-0 rounded-[2.5rem] bg-gradient-to-br from-gray-900 to-gray-700 p-2">
                        <div className="h-full w-full rounded-[2rem] bg-white/90 p-4">
                            <div className="space-y-3">
                                {[...Array(5)].map((_, i) => (
                                    <div
                                        key={i}
                                        className="h-8 rounded-lg bg-gradient-to-r from-purple-400 to-pink-400 animate-pulse"
                                        style={{
    ...
    },
    {
        ...
        description: "Intelligent AI-powered conversational agents that drive sales and provide 24/7 customer support.",
        href: "#",
        cta: "Deploy AI Agent",
        className: "col-span-3 lg:col-span-1",
    ...
    },
    {
        ...
        description: "Automate complex workflows and connect your tools seamlessly. Save hours every week.",
        href: "#",
        cta: "Automate Now",
        className: "col-span-3 lg:col-span-2",
        background: (
    ...
    },
    {
        ...
        description: "Streamline repetitive tasks and boost productivity with custom automation solutions.",
        href: "#",
                    ...
                    <div className="flex flex-col gap-4">
                        {[...Array(4)].map((_, i) => (
                            <div key={i} className="flex items-center gap-4">
                                <div className="h-8 w-8 rounded-full bg-green-500/60 animate-pulse" />
                                <div className="h-2 w-32 rounded bg-green-500/40 animate-pulse" />
                                <ArrowRightIcon className="h-4 w-4 text-green-500/60 animate-pulse" />
                            </div>
                        ))}
                        <Ripple />
                    </div>
    ...
    },
    {
        ...
        description: "Create engaging user-generated style content at scale with AI-powered video generation.",
        href: "#",
        cta: "Generate Videos",
        className: "col-span-3 lg:col-span-1",
        background: (
            <div className="absolute inset-0 bg-gradient-to-br from-orange-500/20 via-red-500/20 to-pink-500/20">
                <div className="absolute inset-0 flex items-center justify-center gap-2 p-8">
                    {[...Array(3)].map((_, i) => (
                        <div
                            key={i}
                            className="h-32 w-24 rounded-lg bg-gradient-to-br from-orange-500/60 to-pink-500/60 animate-pulse"
                            style={{
    ...
    },
    {
        ...
        description: "Data-driven advertising campaigns that maximize ROI and scale your business profitably.",
        href: "#",
        cta: "Launch Campaign",
        className: "col-span-3 lg:col-span-2",
        background: (
            <div className="absolute inset-0 bg-gradient-to-br from-blue-600/20 via-red-500/20 to-yellow-500/20">
                <div className="absolute inset-0 flex items-center justify-center">
                    <div className="relative h-40 w-40">
                        <div className="absolute inset-0 rounded-full border-4 border-blue-500/60 animate-ping" />
                        <div
                            className="absolute inset-4 rounded-full border-4 border-red-500/60 animate-ping"
                            style={{ animationDelay: "0.5s" }}
                        />
                        <div
                            className="absolute inset-8 rounded-full border-4 border-yellow-500/60 animate-ping"
                            style={{ animationDelay: "1s" }}
                        />
                        <div className="absolute inset-0 flex items-center justify-center">
                            <Target className="h-16 w-16 text-blue-500/80" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    },
    {
        ...
        description: "Scale your organic traffic with automated, data-driven SEO strategies and geo-targeting.",
        href: "#",
        cta: "Boost SEO",
        className: "col-span-3 lg:col-span-1",
        background: (
            <div className="absolute inset-0">
                <Marquee className="absolute top-10 [--duration:30s]" pauseOnHover>
                    {technologies.map((tech, idx) => (
                        <div
                            key={idx}
                            className="relative w-24 h-24 rounded-xl border border-gray-300/20 bg-white/5 backdrop-blur-sm flex flex-col items-center justify-center gap-2"
                        >
    ...
    },
    {
        ...
        className: "col-span-3 lg:col-span-1",
        background: (
            <div className="absolute inset-0 bg-gradient-to-br from-sky-500/20 via-blue-500/20 to-indigo-500/20">
                <div className="absolute inset-0 flex items-center justify-center p-8">
                    <div className="relative">
                        <Cloud className="h-32 w-32 text-sky-500/60 animate-pulse" />
                        <div className="absolute inset-0 flex items-center justify-center gap-6">
                            {[...Array(4)].map((_, i) => (
                                <div
                                    key={i}
                                    className="absolute h-8 w-8 rounded-full bg-blue-500/60 animate-pulse"
                                    style={{
    ...
    },
    {
        ...
        description: "Autonomous systems that handle marketing, sales, and operations while you focus on strategy.",
        href: "#",
        cta: "Build Ecosystem",
        className: "col-span-3 lg:col-span-2",
        background: (
            <div className="absolute inset-0 bg-gradient-to-br from-violet-500/20 via-fuchsia-500/20 to-pink-500/20">
                <div className="absolute inset-0 overflow-hidden">
                    {[...Array(30)].map((_, i) => (
                        <div
                            key={i}
                            className="absolute h-2 w-2 rounded-full bg-white/60 animate-pulse"
                            style={{
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <div className="relative">
                            {[...Array(6)].map((_, i) => (
                                <div
                                    key={i}
                                    className="absolute h-20 w-20 rounded-full border-2 border-fuchsia-500/40"
                                    style={{
                                        transform: `rotate(${i * 60}deg) translateY(-60px)`,
                                    }}
                                />
                            ))}
                            <div className="h-20 w-20 rounded-full bg-gradient-to-br from-violet-500/60 to-fuchsia-500/60 animate-pulse" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    },
    {
        ...
        background: (
            <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/20 to-purple-500/20">
                <div className="absolute inset-0 flex items-center justify-center">
                    <Rocket className="h-32 w-32 text-indigo-500/40 animate-bounce" style={{ animationDuration: "3s" }} />
                </div>
            </div>
        ),
    },
...
export default function ServicesBento() {
    ...
    return (
        <section ref={sectionRef} className="w-full pt-10 px-4 md:px-8">
            <div className="max-w-7xl mx-auto">
                <div ref={headingRef} className="text-center mb-16">
                    ...
                    <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                        From idea to execution, we build the technology infrastructure that scales your business
                    </p>
                </div>

                <BentoGrid ref={cardRef}>
